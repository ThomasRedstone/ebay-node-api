...
let eBay = require("../src");
let buildURL = require("../src/buildURL");

describe("test building url methods", () => {
  it("test search url", () => {
    "https://svcs.ebay.com/services/search/FindingService/v1?SECURITY-APPNAME=testID&OPERATION-NAME=findItemsByKeywords&SERVICE-VERSION=1.0.0&RESPONSE-DATA-FORMAT=JSON&outputSelector(0)=SellerInfo&paginationInput.entriesPerPage=6&GLOBAL-ID=EBAY-US";
    let expected_search_url =
